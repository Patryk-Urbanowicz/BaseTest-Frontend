    ...
    return (
        <form className="max-w-sm mx-auto" onSubmit={handler}>
            ...
            <label htmlFor="questionsType" className="block mb-2 text-sm font-medium text-gray-900">Questions
                type:</label>
            <select id="questionsType" defaultValue=""
            ...
            <label htmlFor="number-input" className="block mb-2 text-sm font-medium text-gray-900"> Number of
                questions: </label>
            <input type="number" id="questionsNumber" aria-describedby="helper-text-explanation"
                   ...
                   required defaultValue={10} min={1} max={50} step={1}/>
